    ...
    <div className="signInDiv">
        ...
        <div className="content">
           <div className="titlesPart">
                ...
                <h4 className="title2">Connectez vous à votre compte </h4>
           </div>
                ...
                <div className="afterLogo">
                    <form className="form" type= 'POST' encType="multipart/form-data" onSubmit={handleFormSubmit}>
                        ...
                        <div className="butonPlus">
                            <a className="title2" href="./ForgotPassword">Mot de passe oublié ?</a>
                            <button className="buton" type="submit">
                                Se connecter
                            </button>
                        </div>
                    </form>
                    <p className="title2">Vous n'avez pas de compte?<a className="lienInsc" href="./Inscription">Inscrivez vous</a></p>
                </div>
           </div> 
        </div>
    </div>
